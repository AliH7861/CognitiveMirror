...
export default function LiveSidebar({
    ...
    return (
        <div className={`w-full h-full bg-white dark:bg-slate-900 overflow-y-auto transition-all duration-300 ${isExpanded ? 'h-[50vh]' : 'h-auto'} lg:h-full`}>
            <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
                {/* Header - Always Visible */}
                <div onClick={toggleExpand} className="cursor-pointer lg:cursor-default">
                ...
                <div className={`${isExpanded ? 'block' : 'hidden'} lg:block space-y-4 lg:space-y-6`}>
